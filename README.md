...
image = cv2.imread('undertaker.jpg')

if image is None:
    print("Error: undertaker.jpg not found")
    exit()
...
![alt text](<Screenshot 2026-08-21 091232.png>)
...
![alt text](<Screenshot 2026-08-21 091241.png>)
...
![alt text](<Screenshot 2026-08-21 091249.png>)
...
![alt text](<Screenshot 2026-08-21 091304.png>)
